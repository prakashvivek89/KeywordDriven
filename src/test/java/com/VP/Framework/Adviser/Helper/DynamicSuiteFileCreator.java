...
/**
 * This class creates the dynamic testng XMLs for each excel test suite.
 * Once dynamic testng XMLs are created it executes them.
 */

public class DynamicSuiteFileCreator {

	String packageName = "com.VP.Framework.Adviser.Testcases";
	...
	public static XmlSuite createXMLSuite(String suiteName, String tcID) throws Exception {
		...
		if (tcID.contains(",")) {
			...
			for (String id : tcID.split(",")) {
				...
				packageName = new XmlClass("com.VP.Framework.Adviser.Testcases." + className);
			...
			test.setName(tcID);
			List<XmlClass> classes = new ArrayList<XmlClass>();
			XmlClass packageName = new XmlClass("com.VP.Framework.Adviser.Testcases." + suiteName);
