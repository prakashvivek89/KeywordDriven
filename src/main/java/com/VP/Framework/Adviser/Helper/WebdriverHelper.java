...
import com.VP.Framework.Adviser.Helper.TakeScreenshotUtility;
import com.VP.Framework.Adviser.ReadExcel.ReadProjectReusables;
...
public class WebdriverHelper {
	...
	public void beforeSuite(ITestContext ctx) throws Exception {
		...
		ReadTestcaseFile.readTestcaseFile(ctx.getCurrentXmlTest().getSuite().getName());;
	}
	...
	public void tearDown(ITestResult result) throws IOException {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			Reporting.test.log(Status.FAIL, ReadProjectReusables.methodName + "<br />"
